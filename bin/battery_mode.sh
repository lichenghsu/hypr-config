...
enable_battery() {
    ...
    /home/miles/.config/hypr/scripts/switch_theme.sh black
    sleep 0.5
...
disable_battery() {
    ...
    /home/miles/.config/hypr/scripts/switch_theme.sh minimal
    sleep 0.5
...
[ -n "$QS_PID" ] && quickshell ipc --pid "$QS_PID" call qsIpc refreshBatteryMode
