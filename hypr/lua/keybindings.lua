...
hl.bind("SHIFT + PRINT", hl.dsp.exec_cmd(p.screenshot_full))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(p.powermenu))
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd(p.lock))
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd(p.lock))
...
hl.bind(mainMod .. " + CTRL + right", hl.dsp.exec_cmd("/home/miles/.local/bin/wallpaper.sh --next"))
hl.bind(mainMod .. " + CTRL + left",  hl.dsp.exec_cmd("/home/miles/.local/bin/wallpaper.sh --previous"))
...
hl.bind(mainMod .. " + B", function()
    ...
    hl.exec_cmd("/home/miles/.local/bin/battery_mode.sh")
end)
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("/home/miles/.local/bin/smart_volume.sh up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("/home/miles/.local/bin/smart_volume.sh down"), { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd("/home/miles/.local/bin/smart_volume.sh mute"), { locked = true })
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("/home/miles/.local/bin/smart_brightness.sh up"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("/home/miles/.local/bin/smart_brightness.sh down"), { locked = true, repeating = true })
